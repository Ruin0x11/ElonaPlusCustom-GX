# Elona+ Custom-GX 2.06fix

*\~Believe in Jure and hold a determination to mince.\~*

Elona+ Custom-GX is a new variant of Elona+ based on Elona+ Custom-G, updated with the changes in Elona+ up to version 2.06fix.

### **[Download the latest release here.](https://github.com/Ruin0x11/ElonaPlusCustom-GX/releases/)**

## Installation

1. Download Elona+ 2.06fix from [here](https://mega.nz/file/YzAGDZbD#KpAKCByCrgbHZYV0OU0C_QLIjGPgE6sJISkMgVBKrls). Extract it to `elonaplus2.06fix`.
2. Extract the contents of Custom-GX's archive to the `elonaplus2.06fix` folder, overwriting all existing files.
3. Run `elonapluscgx.exe`.

## Building

1. Follow the installation instructions above. Rename the `elonaplus2.06fix` folder to `2.05-custom-gx` and move it to the `assets/` folder of this repository.
